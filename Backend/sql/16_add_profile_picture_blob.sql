...
SET @preparedStatement = (SELECT IF(
  ...
  "SELECT 1",
  CONCAT("ALTER TABLE ", @tablename, " ADD COLUMN ", @columnname, " LONGBLOB NULL AFTER profile_picture_uploaded_at")
));
...
SET @preparedStatement2 = (SELECT IF(
  ...
  "SELECT 1",
  CONCAT("ALTER TABLE ", @tablename, " ADD COLUMN ", @columnname2, " VARCHAR(100) NULL AFTER profile_picture_data")
));
