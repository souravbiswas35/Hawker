    ...
    @preparedStatement = (
        SELECT IF(
                (
                    ...
                    "ALTER TABLE ", @tablename, " ADD COLUMN ", @columnname, " VARCHAR(500) NULL AFTER business_type"
                )
            )
    );
    ...
    @preparedStatement2 = (
        SELECT IF(
                (
                    ...
                    "ALTER TABLE ", @tablename, " ADD COLUMN ", @columnname2, " TIMESTAMP NULL"
                )
            )
    );
    ...
    @preparedStatement3 = (
        SELECT IF(
                (
                    ...
                    "ALTER TABLE ", @tablename2, " ADD COLUMN ", @columnname3, " ENUM('pending', 'verified', 'rejected') NOT NULL DEFAULT 'pending' AFTER file_size"
                )
            )
    );
    ...
    @preparedStatement4 = (
        SELECT IF(
                (
                    ...
                    "ALTER TABLE ", @tablename2, " ADD COLUMN ", @columnname4, " TIMESTAMP NULL"
                )
            )
    );
    ...
    @preparedStatement5 = (
        SELECT IF(
                (
                    ...
                    "ALTER TABLE ", @tablename2, " ADD COLUMN ", @columnname5, " BIGINT UNSIGNED NULL"
                )
            )
    );
