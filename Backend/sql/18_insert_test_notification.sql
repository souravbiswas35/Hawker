...
SET @vendor_user_id = (SELECT id FROM users WHERE role = 'vendor' LIMIT 1);

-- Insert a test notification
INSERT INTO vendor_notifications (user_id, category, title, message, link, is_read, created_at, updated_at)
VALUES (
  @vendor_user_id,
