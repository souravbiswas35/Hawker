...
-- BEFORE: Payment verification and reporting
-- AFTER: 21_create_missing_payment_tables.sql, 03_license_application_schema.sql (Required)
...
ADD COLUMN payment_status ENUM(
    ...
    'failed',
    'waived'
) NOT NULL DEFAULT 'pending' AFTER payment_required,
