-- Add License Fields (license_number, issued_at, expires_at)
-- Adds fields to track license issue and expiration dates
-- BEFORE: 13_fix_approved_licenses.sql, 17_fix_approved_license_fields.sql
-- AFTER: 03_license_application_schema.sql, 05_fix_license_application_status.sql (Required)
