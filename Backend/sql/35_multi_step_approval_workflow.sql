...
-- AFTER: 01_hawker_schema.sql, 03_license_application_schema.sql (Required)
...
SET
    @has_city_corp = IF(
        @role_enum LIKE '%city_corporation_admin%',
        1,
        0
    );
...
SET
    @column_exists = (
        ...
        WHERE
            ...
            AND COLUMN_NAME = 'document_verification_status'
    );
...
SET
    @fk_exists = (
        ...
        WHERE
            TABLE_SCHEMA = 'hawker'
            AND TABLE_NAME = 'license_applications'
            AND CONSTRAINT_NAME = 'fk_document_verified_by'
    );
...
VALUES (
        'inspector@hawker.com',
        '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5GyW0e5K0vJ6i',
        'inspector',
        1,
        'active'
    );
...
VALUES (
        'citycorp@hawker.com',
        '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5GyW0e5K0vJ6i',
        'city_corporation_admin',
        1,
        'active'
    );

INSERT INTO
    city_corp_admin_profiles (
        user_id,
        employee_id,
        department,
        phone,
