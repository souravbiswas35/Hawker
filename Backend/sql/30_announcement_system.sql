...
-- BEFORE: Announcement dependent features
...
VALUES (
        ...
        'We have improved the license application process with a new 6-step form. The new process is more streamlined and user-friendly. Please review the updated guidelines before applying.',
        'new_features',
        TRUE,
        'high',
        NOW()
    ...
    (
        ...
        'Please note the updated holiday schedule for the upcoming month. All vending zones will be closed on national holidays.',
        'holidays',
        TRUE,
        'high',
        NOW()
    ...
    (
        1,
        'Policy Change: Zone Assignment',
        'Effective from next month, zone assignments will be based on a new priority system. Please check your dashboard for updated zone information.',
        'policy_changes',
        FALSE,
        'medium',
        NOW()
