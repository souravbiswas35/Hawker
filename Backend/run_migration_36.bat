@echo off
REM Script to run the notification action types migration

echo ========================================
echo Running Notification Action Types Migration
echo ========================================
echo.
...
SET SCRIPT_DIR=%~dp0
SET SQL_FILE=%SCRIPT_DIR%sql\36_update_notification_action_types.sql
...
echo Running migration file: 36_update_notification_action_types.sql
echo.
